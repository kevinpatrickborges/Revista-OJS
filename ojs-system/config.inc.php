...
; Copyright (c) 2025 Kevin-Nugecid
...
base_url = "http://10.9.9.84:8080"
; base_url[override] = "http://10.9.9.84:8080"
absolute_asset_urls = On
...
;    Example1: base_url[index] = http://10.9.9.84:8080
...
allowed_hosts = "[\"localhost\", \"10.9.9.84\"]"
...
salt = "9u8H5v3R2t1ZQw7XcV4bN5M6k8J7h3G2d1F9s8A7"

; The unique secret used for encoding and decoding API keys
api_key_secret = "p2O9i8U7y6T5r4E3w2Q1z0X9c8V7b6N5m4"
...
smtp_auth = On
smtp_username = rpcirn1@gmail.com
smtp_password = "ewip ftdy czof aozx"
...
default_envelope_sender = rpcirn1@gmail.com
...
; force_dmarc_compliant_from_displayname = '%n via %s'
