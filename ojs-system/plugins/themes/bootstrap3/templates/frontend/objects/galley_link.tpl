...
<a class="galley-link btn {if $isSupplementary}btn-default{else}btn-primary{/if} {$type}" role="button" href="{url page=$page op="view" path=$path}" style="background:#fff; color:#337ab7; border:1px solid #337ab7;">
