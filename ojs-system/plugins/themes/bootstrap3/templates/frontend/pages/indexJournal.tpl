 ...
 *}
{include file="frontend/components/headerTelaPrincipal.tpl" pageTitleTranslated=$currentJournal->getLocalizedName()}
...
{include file="frontend/objects/galley_link_hover_style.tpl"}
            <a href="{url router=\PKP\core\PKPApplication::ROUTE_PAGE page="issue" op="archive"}" class="btn btn-primary read-more" style="background:#fff; color:#337ab7; border:1px solid #337ab7;">
